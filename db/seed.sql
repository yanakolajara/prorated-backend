...
INSERT INTO
  contractors(name, description, ratings, reviews, logo)
VALUES
  ('Smith Construction', 'General construction services for residential and commercial projects', 4.8, 35, 'https://i.imgur.com/Pteh4jv.png'),
  ('GreenScape Landscaping', 'Specializing in sustainable and creative landscaping solutions', 4.5, 28, 'https://i.imgur.com/O48kP3E.png'),
  ('Swift Roofing Experts', 'Swift and reliable roofing services with attention to detail', 4.9, 42, 'https://i.imgur.com/i800wRz.png'),
  ('PlumbMasters', 'Your go-to experts for all plumbing needs, from repairs to installations', 4.7, 39, 'https://i.imgur.com/6T5TyXz.png'),
  ('PowerSpark Electricians', 'Powerful solutions for all your electrical needs', 4.7, 37, 'https://i.imgur.com/LKDY6qY.png'),
  ('ColorSplash Painters', 'Transforming spaces with a splash of colors and professional painting', 4.9, 47, 'https://i.imgur.com/J4XaYF8.png'),
  ('FloorCrafters', 'Crafting beautiful and durable floors with precision and expertise', 4.8, 36, 'https://i.imgur.com/eatKemZ.png'),
  ('CoolBreeze HVAC', 'Keeping your home comfortable with top-notch HVAC maintenance', 4.7, 40, 'https://i.imgur.com/W3LnoNR.png'),
 ('MasterCrafter Carpentry', 'Masterful carpentry and woodwork for unique and custom projects', 4.8, 38, 'https://i.imgur.com/O48kP3E.png');
